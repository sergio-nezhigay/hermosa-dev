// Ensure SearchForm is available before defining MainSearch
if (typeof SearchForm !== 'undefined') {
  ...
  // Fallback if SearchForm is not available
  console.warn('SearchForm is not defined. MainSearch functionality may be limited.');
}
